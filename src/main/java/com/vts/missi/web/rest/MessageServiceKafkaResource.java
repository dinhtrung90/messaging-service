...
@RestController
@RequestMapping("/api/message-service-kafka")
public class MessageServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(MessageServiceKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MessageServiceKafkaResource(KafkaProperties kafkaProperties) {
